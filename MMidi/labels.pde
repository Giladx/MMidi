void labels(){
   ...
   fill(#1D4383);
  text("Myo-Midi/OSC", width/2+width/8,height/18);
   ...
   text("giladx - 2015", width-cons.width/1.15, height-height/40); 
   text("www.blobim.com", width-cons.width/1.15, height-height/120);
